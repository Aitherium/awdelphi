"""Stack-aware `doctor` for awdelphi.
...
interesting failures live BETWEEN them. "awdelphi is installed" is not the useful
fact -- "awdelphi is installed and the thing it pairs with is not" is. This reports
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWDELPHI_BEARER_FILE', 'AWDELPHI_GATEWAY', 'AWDELPHI_INTERNAL_KEY']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awdelphi needs at runtime, and a
